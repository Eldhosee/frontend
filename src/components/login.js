        ...
        <Col lg={6} className='left'>
          <div className='left-col' >
            ...
            <div>
                ...
                <Form onSubmit={Login}>
                  <div className="input-container">
                    <div className="label-wrapper">
                      <label className="label " id="email-label" for="email" data-spec="label-label">
                        <span className="label__content">Email address</span>
                      </label>
                    </div>
                  ...
                  <div className="input-container">
                    <div className="label-wrapper">
                      <label className="label " id="password-label" for="password" data-spec="label-label">
                        <span className="label__content">Password</span>
                      </label>
                    </div>
                    <input type="password" data-spec="input-field-input-element" aria-invalid="false" className="input" data-automation="authentication-email-field" id="password" name="password" value={password} role="textbox"
              ...
              <br />
              <button className='btn-2'>Email me a Login Link</button>
              <br />
